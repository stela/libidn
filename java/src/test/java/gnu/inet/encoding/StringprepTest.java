...
public class StringprepTest {
  private enum Profile {
    NODE_PREP {
        @Override
        String prep(final String in, final boolean allowUnassigned) throws StringprepException {
  ...
  // test cases converted to Java from tst_stringprep.CLASSES
  private final Check[] checks = new Check[] {
          new Check("Map to nothing", "foo\u00ad\u034f\u1806\u180bbar\u200b\u2060baz\ufe00\ufe08\ufe0f\ufeff",
                    "foobarbaz"),
...
//          new Check("Case folding U+2121 U+33C6 U+1D7BB", "\u2121\u33c6\ud835\udfbb", "telc\u2215kg\u03c3"),
          ...
          new Check("Bidi: RandALCat character U+05BE and LCat characters", "foo\u05bebar", "", Profile.NAME_PREP,
                    true, true),
          new Check("Bidi: RandALCat character U+FD50 and LCat characters", "foo\ufd50bar", "", Profile.NAME_PREP,
                    true, true),
          new Check("Bidi: RandALCat character U+FB38 and LCat characters", "foo\ufe76bar", "foo \u064ebar"),
          new Check("Bidi: RandALCat without trailing RandALCat U+0627 U+0031", "\u06271", "", Profile.NAME_PREP,
                    true, true),
          ...
          new Check("Larger test (shrinking)", "X\u00ad\u00df\u0130\u2121j\u030c\u00a0\u00aa\u03b0\u2000",
                    "xssi\u0307tel\u01f0 a\u03b0 "),
          new Check("Larger test (expanding)", "X\u00df\u3316\u0130\u2121\u249f\u3300",
          ...
          new Check("bidi both RandALCat and LCat  U+0627 U+00AA U+0628", "\u0627\u00aa\u0628", "", Profile.NAME_PREP,
                    true, true),
          new Check("XMPP node profile prohibited output", "foo@bar", "", Profile.NODE_PREP, true, true),
          new Check("XMPP resource profile on same string should work though", "foo@bar", "foo@bar",
                    Profile.RESOURCE_PREP, true, false)
  };
