...
public class Stringprep {
   ...
   */
  public static String nameprep(final String input)
   ...
   * @throws NullPointerException If the name is null.
   */
  public static String nameprep(final String input, final boolean allowUnassigned)
    throws StringprepException {
    if (input == null) {
    ...
    filter(s, RANGE_B1);
    map(s, RFC3454.B2_SEARCH, RFC3454.B2_REPLACE);
    ...
    // map(s, RFC3454.B3_SEARCH, RFC3454.B3_REPLACE);
   ...
   */
  public static String nodeprep(final String input)
    throws StringprepException {
   ...
   * @throws NullPointerException If the node name is null.
   */
  public static String nodeprep(final String input, final boolean allowUnassigned)
    throws StringprepException {
    if (input == null) {
      throw new NullPointerException();
    }
   ...
   */
  public static String resourceprep(final String input)
    throws StringprepException {
   ...
   * @throws NullPointerException If the resource name is null.
   */
  public static String resourceprep(final String input, final boolean allowUnassigned)
    throws StringprepException {
    if (input == null) {
      throw new NullPointerException();
    }
  ...
  static void filter(final StringBuilder s, final RangeSet f) {
  ...
  static void map(final StringBuilder s, final char[] search, final String[] replace)
  {
